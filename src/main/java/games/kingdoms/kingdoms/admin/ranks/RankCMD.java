                    ...
                    if (target == null) {
                        ...
                        if (args[0].equalsIgnoreCase("set")) {
                            ...
                            if (!plugin.getPlayerRank().containsKey(target.getUniqueId().toString())) {
                                plugin.getPlayerRank().getOrDefault(target.getUniqueId().toString(), ChatColor.DARK_GRAY.toString() + ChatColor.BOLD + Rank.DEFAULT);
                            }
                            ...
                            if (args[2].equalsIgnoreCase("default")) {
                                if (sender.hasPermission("kingdoms.setrank.default")) {
                                    ...
                                    Bukkit.getServer().dispatchCommand(console, "pex user " + target.getName() + " add kingdoms.move");
                            ...
                            if (args[2].equalsIgnoreCase("jrmod")) {
                                if (sender.hasPermission("kingdoms.setrank.jrmod")) {
                                    ...
                                    Bukkit.getServer().dispatchCommand(console, "pex user " + target.getName() + " remove kingdoms.move");
